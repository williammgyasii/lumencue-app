...
/// <summary>Muted thumbnail-sized loop used by background palette tiles.</summary>
public static class BackgroundTilePreview
{
    ...
    public static VideoPlayRequest? RequestFor(LiveBackground item)
    {
        ...
        return new VideoPlayRequest(item.Path, Loop: true, Audio: false, MaxWidth: MaxWidth, MaxHeight: MaxHeight);
    }
}
